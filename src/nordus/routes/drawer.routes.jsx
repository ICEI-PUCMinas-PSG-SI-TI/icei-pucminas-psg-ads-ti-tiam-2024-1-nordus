  ...
  return (
    <Drawer.Navigator
      ...
      drawerContent={(props) => (
        <CustomDrawer
          {...props}
          screenAtual={screenAtual}
          setScreenAtual={setScreenAtual}
        />
      )}
    >
      <Drawer.Screen
  ...
  return (
    ...
    >
      ...
      <DrawerItem
        label={"Serviços"}
        onPress={() => {
          navigation.navigate("Tab", { screen: "Agendamento" });
          setScreenAtual("Agendamento");
        }}
      ...
      <DrawerItem
        ...
        onPress={() => {
          navigation.navigate("Stack", { screen: "Patrocinadores" });
          setScreenAtual("Patrocinadores");
        }}
        activeTintColor={Colors.BLACK}
        inactiveTintColor={Colors.BLACK}
        activeBackgroundColor={Colors.WHITE_SMOKE}
      ...
      <DrawerItem
        label={"Produtos"}
        onPress={() => {
          navigation.navigate("Stack", { screen: "Produtos" });
          setScreenAtual("Produtos");
        }}
        activeTintColor={Colors.BLACK}
        inactiveTintColor={Colors.BLACK}
        activeBackgroundColor={Colors.WHITE_SMOKE}
      ...
      <DrawerItem
        label={"Assinaturas"}
        onPress={() => {
          navigation.navigate("Tab", { screen: "Assinaturas" });
          setScreenAtual("Assinaturas");
        }}
        activeTintColor={Colors.BLACK}
        inactiveTintColor={Colors.BLACK}
        activeBackgroundColor={Colors.WHITE_SMOKE}
      ...
      <DrawerItem
        label={"Equipe"}
        onPress={() => {
          navigation.navigate("Stack", { screen: "Equipe" });
          setScreenAtual("Equipe");
        }}
        activeTintColor={Colors.BLACK}
        inactiveTintColor={Colors.BLACK}
        activeBackgroundColor={Colors.WHITE_SMOKE}
      ...
      <View style={styles.contactGroup}>
        ...
        <Pressable
          ...
          onPress={() =>
            openURL(
              "mailto:barbearianordus@gmail.com?subject=Marcar%20um%20hor%C3%A1rio&body=Estou%20afim%20de%20marcar%20um%20hor%C3%A1rio%20para%20dar%20um%20trato%20no%20cabelo%2Fbarba.%20Cheguei%20at%C3%A9%20voc%C3%AAs%20pelo%20app%20e%20t%C3%B4%20bem%20empolgado%20pra%20conhecer%20de%20perto!%0D%0A%0D%0A"
            )
          }
        >
